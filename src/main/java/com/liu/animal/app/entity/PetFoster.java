...
/**
 * @Author Admin
 * @Description 宠物任务 收养领养
 * @Date 10:27 2020/5/2
 * @return
 **/

public class PetFoster implements Serializable {
    ...
    private List<PetFoster> petFostersList;
    ...
    public List<PetFoster> getPetFostersList() {
        return petFostersList;
    }

    public void setPetFostersList(List<PetFoster> petFostersList) {
        this.petFostersList = petFostersList;
    }
